...
void DrawCubeTextureRec(Texture2D texture, rlRectangle source, Vector3 position, float width, float height, float length, Color color)
{
    float x = position.x;
    float y = position.y;
    float z = position.z;
...
Mesh GenMeshCubicmap(Image cubicmap, Vector3 cubeSize)
{
    ...
    rlRectangleF rightTexUV = { 0.0f, 0.0f, 0.5f, 0.5f };
    rlRectangleF leftTexUV = { 0.5f, 0.0f, 0.5f, 0.5f };
    rlRectangleF frontTexUV = { 0.0f, 0.0f, 0.5f, 0.5f };
    rlRectangleF backTexUV = { 0.5f, 0.0f, 0.5f, 0.5f };
    rlRectangleF topTexUV = { 0.0f, 0.5f, 0.5f, 0.5f };
    rlRectangleF bottomTexUV = { 0.5f, 0.5f, 0.5f, 0.5f };
